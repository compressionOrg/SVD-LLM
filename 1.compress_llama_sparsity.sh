...
create_whitening(){
    ...
    --save_path "whitening" >logs/whitening/${model_name}_whitening_only_ratio_${1}.log
}

evaluate_whitening(){
    python SVDLLM.py \
    --step $1 \
    --model_path "whitening/${model_name}_whitening_only_${2}.pt" >logs/${model_name}_whitening_only_ratio_${2}eval_step${1}.log
}
